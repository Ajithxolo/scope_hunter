...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/Ajithxolo/scope_hunter"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 3.2.0"

  spec.metadata["allowed_push_host"] = "https://rubygems.org"
  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/Ajithxolo/scope_hunter"
  spec.metadata["changelog_uri"] = "https://github.com/Ajithxolo/scope_hunter/blob/main/CHANGELOG.md"
  spec.metadata["rubocop_plugin"] = "ScopeHunter::Plugin"
